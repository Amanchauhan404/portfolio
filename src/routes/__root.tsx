  ...
  head: () => ({
    meta: [
      ...
      { title: "Abhay Sengar — Data Analyst" },
      {
        name: "description",
        content:
          "Abhay Sengar — aspiring data analyst skilled in SQL, Python, Power BI, Tableau and Excel. Portfolio of dashboards, analyses and case studies.",
      },
      { name: "author", content: "Abhay Sengar" },
